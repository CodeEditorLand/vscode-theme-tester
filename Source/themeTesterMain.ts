...
import { openEditors, registerPlayground } from "./playground";

export function activate(context: vscode.ExtensionContext) {
	const playgroundData = vscode.Uri.joinPath(
...
async function findMarketPlaceExtension(
	publisher: string,
	name: string,
